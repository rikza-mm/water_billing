...
# Generation Time: 2025-08-10 12:44:02 +0000
# ************************************************************
...
/*!50003 CREATE */ /*!50017 DEFINER=`root`@`localhost` */ /*!50003 TRIGGER `flag_suspicious_readings` AFTER INSERT ON `meter_readings` FOR EACH ROW BEGIN
...
END */;;
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`root`@`localhost` */ /*!50003 TRIGGER `after_meter_reading_special_case` AFTER UPDATE ON `meter_readings` FOR EACH ROW BEGIN
...
DELIMITER ;;
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO" */;;
/*!50003 CREATE */ /*!50017 DEFINER=`root`@`localhost` */ /*!50003 TRIGGER `before_insert_system_logs` BEFORE INSERT ON `system_logs` FOR EACH ROW BEGIN
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `officer_revenue_view`
AS SELECT
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `monthly_reports`
AS SELECT
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_area_revenue_daily`
AS SELECT
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_customer_history_summary`
AS SELECT
   `c`.`customer_id` AS `id`,
   `c`.`full_name` AS `name`,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_admin_customer_list`
AS SELECT
   `c`.`customer_id` AS `customer_id`,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `customer_debt_summary`
AS SELECT
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_officer_area_income`
AS SELECT
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `monthly_billing_summary`
AS SELECT
   `c`.`customer_id` AS `customer_id`,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `CancelReadingAndBill`(IN `p_bill_id` INT, IN `p_user_id` INT, OUT `p_result` JSON)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ClosePeriodAndRecordRetainedEarnings`(IN `p_start_date` DATE, IN `p_end_date` DATE, IN `p_user_id` INT, OUT `p_result` JSON)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `CreateBillFromReading_v2`(IN `p_customer_id` INT, IN `p_user_id` INT, IN `p_current_reading` DECIMAL(10,2), IN `p_reading_date` DATE, IN `p_notes` TEXT, IN `p_image_url` VARCHAR(255), OUT `p_result` JSON)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GenerateBalanceSheet`(IN `p_end_date` DATE)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetAdminCustomerHistory`(IN `p_customer_id` INT)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetAdminCustomerLedgerTransactions`(IN `p_customer_id` INT)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetAllAppSettings`()
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetCustomerBillingHistory`(IN `p_customer_id` INT)
BEGIN
    SELECT
        b.bill_id,
        b.period_start,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetCustomerDebtPaymentHistory`(IN `p_customer_id` INT)
BEGIN
    SELECT
        p.payment_id,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetOfficerRevenueByAreaReport`(IN `p_start_date` DATE, IN `p_end_date` DATE, IN `p_period_type` VARCHAR(10))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetOfficerRevenueSummary`(IN `p_start_date` DATE, IN `p_end_date` DATE)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetPaymentDetailsForAdmin`(IN `p_payment_id` INT)
BEGIN
    SELECT
        p.payment_id,
        p.transaction_date,
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `GetPetugasDashboardStats`(IN `p_officer_id` INT, OUT `p_result` JSON)
BEGIN
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `InitializeExistingCustomer`(
  ...
  IN p_meter_number INT,
  IN p_last_meter_reading DECIMAL(10,2),
  IN p_last_reading_date DATE,
  IN p_initial_debt DECIMAL(10,2),
  IN p_initial_saldo DECIMAL(10,2),
  IN p_notes TEXT,
...
BEGIN
  ...
  DECLARE v_error_message VARCHAR(255);
  DECLARE v_phone_to_check VARCHAR(20);
  ...
  SET v_phone_to_check = TRIM(p_phone_number);

  -- Cek duplikasi HANYA jika nomor diisi
  IF v_phone_to_check IS NOT NULL AND v_phone_to_check <> '' THEN
    SELECT COUNT(*) INTO v_existing_customer
    FROM customers
    WHERE phone_number = v_phone_to_check;
  ...
  INSERT INTO customers
    (full_name, area_id, category_id, meter_number, phone_number, address, status, registration_date, saldo, hutang)
  VALUES
    (p_full_name, p_area_id, p_category_id, p_meter_number, NULLIF(v_phone_to_check, ''), p_address, 'active', p_registration_date, p_initial_saldo, p_initial_debt);
  ...
  IF p_last_meter_reading >= 0 AND p_last_reading_date IS NOT NULL THEN
    ...
    VALUES (v_customer_id, p_created_by_user_id, 0.00, p_last_meter_reading, p_last_reading_date, 'verified', CONCAT('MIGRASI SISTEM: ', COALESCE(p_notes, '')), NULL);
    SET v_reading_id = LAST_INSERT_ID();
  ELSE
  ...
  IF p_initial_debt > 0 THEN
    ...
    VALUES (v_customer_id, v_reading_id, p_category_id, 0.00, DATE_SUB(p_last_reading_date, INTERVAL 1 MONTH), p_last_reading_date, p_last_reading_date, p_initial_debt, 0.00, 'overdue', 'MIGRASI SISTEM: Akumulasi tunggakan.');
  END IF;

  COMMIT;
  SET p_result = JSON_OBJECT('success', TRUE, 'message', 'Pelanggan lama berhasil dimigrasikan.', 'customerId', v_customer_id);
END */;;
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `PayCustomerDebt`(IN `p_customer_id` INT, IN `p_amount` DECIMAL(10,2), IN `p_method` ENUM('cash','transfer','qris'), IN `p_user_id` INT, IN `p_proof_url` VARCHAR(255), OUT `p_result` JSON)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ProcessSinglePayment_v2`(IN `p_bill_id` INT, IN `p_user_id` INT, IN `p_amount_paid` DECIMAL(10,2), IN `p_method` ENUM('cash','transfer','qris'), IN `p_use_balance` BOOLEAN, IN `p_proof_url` VARCHAR(255), OUT `p_result` JSON)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `ReconcileDailyBalance`(IN `p_date` DATE)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `SuspendOverdueCustomers`()
BEGIN
    UPDATE customers c
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `SyncOfflineData`(IN `officer` INT)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `UpdateAppSetting`(IN `p_key` VARCHAR(50), IN `p_value` TEXT)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `UpdateCustomerPhoneNumber`(IN `p_customer_id` INT, IN `p_phone_number` VARCHAR(20))
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `update_bill_status_final`(IN `p_bill_id` INT)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `update_customer_debt_final`(IN `p_customer_id` INT)
BEGIN
...
/*!50003 SET SESSION SQL_MODE="NO_AUTO_VALUE_ON_ZERO"*/;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `UseBalanceToPayBills`(IN `p_customer_id` INT, IN `p_user_id` INT, OUT `p_result` JSON)
BEGIN
